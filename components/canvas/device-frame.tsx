...
const DeviceFrame = ({
    ...
    const fullHtml = useMemo(() => getHTMLWrapper(html, title, theme_style, frameId), [html, title, theme_style, frameId]);
  ...
  return (
    ...
    disableDragging={toolMode !== TOOL_MODE_ENUM.SELECT}
    enableResizing={isSelected && toolMode === TOOL_MODE_ENUM.SELECT}
    scale={scale}
